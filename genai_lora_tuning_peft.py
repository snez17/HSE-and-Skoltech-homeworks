# -*- coding: utf-8 -*-
"""GenAI_LoRA_Tuning_PEFT.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13tW64D2XXOh4squZWV5k8BZFTaYnFauF
...
input_sentences = tokenizer(query, return_tensors="pt")
foundational_outputs_sentence = get_outputs(foundation_model, input_sentences, max_new_tokens=50)

print(tokenizer.batch_decode(foundational_outputs_sentence, skip_special_tokens=True))

"""**Комментарий**: видим, что изначальная модель в целом неплохо распознает запрос. Тем не менее, формулировки общие и в конце некорректно сформулированы строки: "which actions need action".

Найдем датасет о здоровье и дообучим на нем LoRA
"""
...
#train_sample = train_sample.remove_columns('label')
...
"""**Комментарий**: видим, что запрос стал конкретным. Вопросы сформулированы грамотно

Протестируем, изменится ли качество ответа, если понизить параметр **r** до 1
"""
...
"""**Комментарий**: модель обучалась в 1,5 раза дольше"""
...
"""**Комментарий**: видим, как при понижении параметра **r** качество ответа значительно ухудшилось и к концу запроса стало нечитаемым"""